...
Confident, precise, and music-native. The interface should feel technically dependable without resembling infrastructure software, and expressive without competing with the user's library.

## Anti-references

Avoid generic SaaS dashboards, crypto-style neon gradients, glass-heavy streaming clones, ornamental waveform decoration, identical card grids, and interfaces that hide migration state behind clever visuals.
...
- Save delight for meaningful feedback rather than decoration.

## Accessibility & Inclusion

Target WCAG 2.2 AA contrast and keyboard operation. Do not rely on provider color alone, preserve visible focus, support reduced motion, keep touch targets comfortable, and ensure status labels remain understandable to screen-reader users.
